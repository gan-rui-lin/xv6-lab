...
//* ip支持的上层协议相关配置项
//* ===============================================================================================
#define SUPPORT_SACK    0		//* 系统是否支持sack项
...
//* 网络工具配置项
//* ===============================================================================================
#define NETTOOLS_PING       0 //* 使能或禁止ping，置位使能，复位禁止，下同
#define NETTOOLS_DNS_CLIENT 0 //* 使能或禁止dns查询客户端
#define NETTOOLS_SNTP       0 //* 使能或禁止sntp客户端
