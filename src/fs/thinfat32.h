...
int tf_attach_image(const char *path);   /* open existing image file (r+b), return 0 success, <0 fail */
int tf_detach_image(void);               /* close current backend, return 0 */
// FILE *tf_get_backend(void);              /* return FILE* or NULL */
